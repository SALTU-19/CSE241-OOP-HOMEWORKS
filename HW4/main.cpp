	...
	while(option != 5){
		...
		case 3:
			...
			if(games[game1] == games[game2])
				cout <<"Game " << games[game1].getGamenumber() <<"'s marks equal to Game " << games[game2].getGamenumber() << endl;
			else
				cout <<"Game " << games[game2].getGamenumber() <<"'s marks not equal to Game " << games[game1].getGamenumber() << endl;
